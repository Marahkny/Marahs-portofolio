    ...
    <section className=" py-5" style={{ backgroundColor: '#E46698', color: '#ffffff' }}>
      <Container className="py-5">
        <Row className=" justify-content-center align-items-center">
          ...
          <h2 style={{ fontSize: '55px', fontWeight: 'bold', fontFamily: 'Patrick Hand, cursive',paddingBottom:'20px' }}>TechCity</h2>
  ...
  <Container className="py-5">
    <Row className="justify-content-center align-items-center">
      ...
      <Col lg={6} md={12} className="text-lg-start mt-4 mt-lg-0 order-2 order-lg-1">
        <h2 style={{ fontSize: '55px', fontWeight: 'bold',fontFamily: 'Patrick Hand, cursive', paddingBottom:'20px' }}>Klimatkoll</h2>
        <p style={{ fontSize: '20px', paddingBottom:'20px' }}>
