...
<section className=" max-w-8xl px-6 flex flex-col items-center justify-center h-full 
  ...
  <div className="max-w-5xl text-center py-6 justify-center lg:py-20">
    ...
    <p className="text-[18px] sm:text-[18px] text-center md:text-[24px] lg:text-[30px] pt-6 leading-relaxed">
...
<p className="text-[18px] sm:text-[18px] md:text-[24px] text-center lg:text-[30px] pt-6 leading-relaxed">We specialize in modern, high-performing web and design solutions, combining creativity and innovation.
