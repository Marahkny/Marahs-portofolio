...
export default function Seohjälp() {
  return (
    <div className="flex justify-center items-center h-full px-6 py-20">
      <div className="text-center max-w-4xl w-full">
        <h2>Vi gör ditt förtag syns med SEO & analys</h2>

        <p className="text-gray-300 leading-relaxed py-6 text-2xl">
Vi optimerar din hemsida med rätt nyckelord baserat på sökningar, så att kunder enkelt hittar dig. Samtidigt spårar vi användarbeteende för att göra sidan mer användarvänlig. </p>
