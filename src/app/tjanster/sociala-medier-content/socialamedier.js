    ...
    <>{/* Meta Pixel Script */}
      ...
      <section className=" h-full py-20 px-6">
        <div className="max-w-7xl mx-auto mt-20 text-left">
          <h1 className="mb-10">Lyft ditt företag med engagerande innehåll!</h1>
...
Vi hjälper dig att skapa engagerande och professionellt innehåll för sociala medier som stärker ditt varumärke, når din målgrupp och ökar engagemanget. Från kreativa inlägg och grafik till strategisk planering – vi gör det enkelt för ditt företag att synas och växa online. </p>
              ...
              <li className="flex items-center">
                ...
                <span >Innehållsskapande & publiceringsplan</span>

              </li>
              <li className="flex items-center">
                <FiCheckCircle className="text-[20px] text-[#E95D0F] mr-3" />
                <span >Strategi för sociala medier</span>
              </li>
              <li className="flex items-center">
                <FiCheckCircle className="text-[20px] text-[#E95D0F] mr-3" />
                <span >Reels & videoformat</span>
              </li>
