...
export default function SocialaMeider() {
  return (
    <>{/* Meta Pixel Script */}
<Script
  id="meta-pixel"
  ...
  />
      ...
      <section className="text-[#F5F5F5] bg-[#F5F5F5] h-full py-20 px-6">
        <div className="max-w-8xl mx-auto text-left">
          <h1 className="mb-10 text-[#121212]">Lyft ditt företag med engagerande innehåll!</h1>
...
Vi hjälper dig att skapa engagerande och professionellt innehåll för sociala medier som stärker ditt varumärke, når din målgrupp och ökar engagemanget. Från kreativa inlägg och grafik till strategisk planering – vi gör det enkelt för ditt företag att synas och växa online. </p>
               <ul className="space-y-4 ">
              <li className="flex items-center">
                <FiCheckCircle className="text-[20px] text-[#3B429F] mr-3" /> 
                <span className="text-[#121212] ">Innehållsskapande & publiceringsplan</span>

              </li>
              <li className="flex items-center">
                <FiCheckCircle className="text-[20px] text-[#3B429F] mr-3" />
                <span className="text-[#121212] ">Strategi för sociala medier</span>
              </li>
              <li className="flex items-center">
                <FiCheckCircle className="text-[20px] text-[#3B429F] mr-3" />
                <span className="text-[#121212] ">Reels & videoformat</span>
              </li>
