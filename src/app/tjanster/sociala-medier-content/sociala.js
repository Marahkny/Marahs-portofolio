...
export default function Sociala() {
  return (
    <div className="flex justify-center items-center h-full px-6 py-20">
      <div className="text-center max-w-4xl w-full">
        <h2>Vi tar hand om dina sociala medier</h2>

        <p className="text-gray-300 leading-relaxed py-6 text-2xl">
Vi gör dina sociala medier riktade mot din målgrupp. Vi skriver engagerande content och skapar bilder samt redigerar film.</p>
